  ...
  config: {
    ...
    parameters: {
      conditions: {
        ...
        conditions: [
          {
            leftValue: expr('{{ $json.intent }}'),
            rightValue: "menu.start",
